...
# ==============================================================================
# -- Generate LIBSTDCPP_TOOLCHAIN_FILE -----------------------------------------
# ==============================================================================

log "Generating ${LIBSTDCPP_TOOLCHAIN_FILE}..."

cat >${LIBSTDCPP_TOOLCHAIN_FILE} <<EOL
...
# ==============================================================================
# -- Generate LIBCPP_TOOLCHAIN_FILE --------------------------------------------
# ==============================================================================

log "Generating ${LIBCPP_TOOLCHAIN_FILE}..."

# We can reuse the other toolchain.
cp ${LIBSTDCPP_TOOLCHAIN_FILE} ${LIBCPP_TOOLCHAIN_FILE}
